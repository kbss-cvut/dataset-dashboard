        ...
        return (<div>
                <ResponsiveReactGridLayout
                    ...
                    <div key="main">
                        ...
                        widget={(content:any, excludedEntities:any) => <SchemaWidget descriptorContent={content} excludedEntities={excludedEntities}/>}
                    ...
                    <div key="rightbottom">
                        <WidgetPanel
                            // @ts-ignore
                        title="Temporal"
                        widget={(content:any, excludedEntities:any) => <TemporalWidget descriptorContent={content}/>}
